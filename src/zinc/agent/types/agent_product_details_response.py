...
class AgentProductDetailsResponse(UniversalBaseModel):
    ...
    status: AgentProductDetailsResponseStatus = pydantic.Field()
    """
    ...
    variant_specifics: typing.Optional[typing.List[AgentProductDetailsResponseVariantSpecificsItem]] = pydantic.Field(
        default=None
    )
    """
    ...
    all_variants: typing.Optional[typing.List[AgentProductDetailsResponseAllVariantsItem]] = pydantic.Field(
        default=None
    )
    """
    ...
    epids: typing.Optional[typing.List[AgentProductDetailsResponseEpidsItem]] = pydantic.Field(default=None)
    """
    ...
    package_dimensions: typing.Optional[AgentProductDetailsResponsePackageDimensions] = pydantic.Field(default=None)
    """
    ...
    offers: typing.Optional[typing.List[AgentProductDetailsResponseOffersItem]] = pydantic.Field(default=None)
    """
    ...
    variants: typing.Optional[typing.List[AgentProductDetailsResponseVariantsItem]] = pydantic.Field(default=None)
    """
