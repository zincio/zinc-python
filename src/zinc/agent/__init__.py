...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "AgentProductDetailsResponseAllVariantsItem": ".types",
    "AgentProductDetailsResponseAllVariantsItemVariantSpecificsItem": ".types",
    "AgentProductDetailsResponseEpidsItem": ".types",
    "AgentProductDetailsResponseOffersItem": ".types",
    "AgentProductDetailsResponsePackageDimensions": ".types",
    "AgentProductDetailsResponsePackageDimensionsSize": ".types",
    "AgentProductDetailsResponsePackageDimensionsSizeDepth": ".types",
    "AgentProductDetailsResponsePackageDimensionsSizeLength": ".types",
    "AgentProductDetailsResponsePackageDimensionsSizeWidth": ".types",
    "AgentProductDetailsResponsePackageDimensionsWeight": ".types",
    "AgentProductDetailsResponseStatus": ".types",
    "AgentProductDetailsResponseVariantSpecificsItem": ".types",
    "AgentProductDetailsResponseVariantsItem": ".types",
    "AgentProductDetailsResponseVariantsItemPropertiesItem": ".types",
    "AgentProductOffersRequestRetailer": ".types",
    "AgentProductOffersResponse": ".types",
    "AgentProductOffersResponseOffersItem": ".types",
    "AgentProductOffersResponseOffersItemCondition": ".types",
    "AgentProductOffersResponseOffersItemHandlingDays": ".types",
    "AgentProductOffersResponseOffersItemSeller": ".types",
    "AgentProductOffersResponseOffersItemShippingOptionsItem": ".types",
