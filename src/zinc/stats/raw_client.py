...
class RawStatsClient:
    ...
    ) -> HttpResponse[DeliveryMapResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    DeliveryMapResponse,
                    parse_obj_as(
                        type_=DeliveryMapResponse,  # type: ignore
    ...
    def get_lifetime_stats(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> HttpResponse[LifetimeStatsResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=LifetimeStatsResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawStatsClient:
    ...
    async def get_delivery_map(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[DeliveryMapResponse]:
        """
        Recent delivered orders as anonymized, city-level map points.
    ...
    async def get_lifetime_stats(
        self, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[LifetimeStatsResponse]:
        """
        Zinc's all-time successful-order count and GMV.
