...
class GetProductDetailsProductsProductIdGetResponsePackageDimensionsSize(UniversalBaseModel):
    width: typing.Optional[GetProductDetailsProductsProductIdGetResponsePackageDimensionsSizeWidth] = None
    depth: typing.Optional[GetProductDetailsProductsProductIdGetResponsePackageDimensionsSizeDepth] = None
    length: typing.Optional[GetProductDetailsProductsProductIdGetResponsePackageDimensionsSizeLength] = None
